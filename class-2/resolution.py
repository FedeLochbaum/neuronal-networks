...
# print('\n')
print("GS with number_of_wrong_numbers: %s" % (gs.gs(graph, initial, number_of_wrong_numbers),))
print('\n')
print("GS with sum_of_manhattan_distance: %s" % (gs.gs(graph, initial, sum_of_manhattan_distance),))
print('\n')